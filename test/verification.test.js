...
const {
  Certificate, Validator, Service, FileCache,
} = require('../src');
...
describe('Testing integration between Certificate and Validator with File Cache', () => {
  beforeEach(async () => {
...
describe('Testing integration between Certificate and Validator with Mongo Cache', () => {
  beforeEach(async () => {
    await Service.setUp();
